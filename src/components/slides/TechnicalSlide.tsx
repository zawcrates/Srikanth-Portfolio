...
const PROJECTS = [
  {
    ...
    tag: 'ML · Python',
    desc: 'Predicting equipment failures using deep learning anomaly detection on sensor telemetry.',
  ...
  },
  {
    ...
    tag: 'IoT · Dashboard',
    desc: 'Real-time geospatial tracking and battery performance telemetry for EV fleets.',
  ...
  },
  {
    ...
    tag: 'AI · Signals',
    desc: 'Real-time audio signal processing pipeline to detect manufacturing defects.',
  ...
  },
  {
    ...
    title: 'AI Dashboard',
    tag: 'React · REST',
    desc: 'Centralized command interface displaying model speed, accuracy drift, and request volumes.',
    slug: 'ai-dashboard',
  },
  {
    num: '05',
    ...
    tag: 'BigQuery · Viz',
    desc: 'Serverless data warehousing and automated pipelines processing multi-million row datasets.',
    slug: 'data-analytics',
  },
];
